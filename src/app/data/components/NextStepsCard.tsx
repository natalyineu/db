      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center border-b border-gray-100 pb-2">
          ...
          <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
            briefStatus === 'Yes' ? 'bg-indigo-100 text-indigo-800' : 'bg-gray-100 text-gray-800'
          }`}>
            Yes
          </span>
        </div>
        ...
        <div className="flex justify-between items-center border-b border-gray-100 pb-2">
          ...
          <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
            paymentStatus === 'Yes' ? 'bg-indigo-100 text-indigo-800' : 'bg-red-100 text-red-800'
          }`}>
        ...
        <div className="flex justify-between items-center border-b border-gray-100 pb-2">
          ...
          <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
            briefStatus === 'Yes' ? 'bg-indigo-100 text-indigo-800' : 'bg-amber-100 text-amber-800'
          }`}>
        ...
        <div className="flex justify-between items-center pb-2">
          ...
          <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
            campaignStatus === 'online' ? 'bg-indigo-100 text-indigo-800' : 
            campaignStatus === 'in progress' ? 'bg-amber-100 text-amber-800' : 
