...
const CampaignItem = memo(({ campaign, onUpdate, showEditButton }: { 
  campaign: Campaign; 
  onUpdate: () => void;
        ...
        <div className="flex-1">
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-2">
              {showEditButton && (
                <button
                  onClick={handleEdit}
                  className="text-sm font-medium text-slate-600 hover:text-slate-900 focus:outline-none flex items-center bg-slate-100 hover:bg-slate-200 px-3 py-1 rounded-md transition-colors"
          ...
          <div className="mt-4 flex items-center">
            <button
              ...
              className="text-sm font-medium text-[#5068FB] hover:text-[#4058EB] focus:outline-none flex items-center bg-[#5068FB]/10 hover:bg-[#5068FB]/20 px-3 py-1 rounded-md transition-colors"
            >
              {showAssets ? (
                <>
                ...
                <>
                  ...
                  {campaign.assets && campaign.assets.length > 0 && (
                    <span className="ml-1 bg-[#5068FB]/20 text-[#5068FB] text-xs px-1.5 py-0.5 rounded-full">
...
const CampaignList = ({ campaigns, isLoading, onRefreshNeeded, showEditButton = false }: { 
